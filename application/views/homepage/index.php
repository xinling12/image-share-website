...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top" role="navigation">
      <div class="container">
      ...
      <?php 
          if ($this->session->userdata('id')) {
              ...
              '<a class="btn btn-primary" href="'.base_url().'homepage/profile">User Profile</a>';
          } else {
...
<div class="jumbotron">
  <div class="container">
    ...
    <div id = "searchbutton">
    <?=form_input($search);?><input type="submit"/></p>
    </div>
    <?=form_close();?>
    ...
    <!-- Example row of columns -->
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body text-center">
              ...
              <p class="card-text">Find your the nearest photography locations around you.</p>
        ...
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body text-center">
            <h5 class="card-title">Online Chat Room</h5>
              <p class="card-text">Chat with others.</p>
              <?php echo '<a class="btn btn-primary" href="'.base_url().'chat">Go</a>' ?>
            </div>
          </div>
        </div>
    <hr>
